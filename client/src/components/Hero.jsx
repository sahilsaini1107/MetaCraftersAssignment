    ...
    >
      <div className="flex  items-center justify-between text-white py-5">
        ...
        <div  className="hidden lg:flex items-center space-x-3 font-semibold opacity-50 ">
          ...
          {connectedAccount ? (
            <div className="flex-row justify-center items-center align-center">
            
            <div className=" flex justify-center items-start pb-5">
              <a
              href={'/Admin'}
              className="bg-gray-500 hover:bg-gray-700 text-white rounded-xl cursor-pointer uppercase shadow-md
